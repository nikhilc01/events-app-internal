...
const mockEvents = {
    events: [
        { title: 'an event', id: 1, description: 'something really cool', location: 'FL,CA', comment: 'testing' },
        { title: 'another event', id: 2, description: 'something even cooler', location: 'FL,CA', comment: 'testing' }
    ]
};
